...
class Knows extends MY_Model {
    ...
    public function brow($values){
        try {
            ...
            $values["filters"]=array(
                ...
                array("name"=>"browser_id_user", "operator"=>"=","fields"=>array("id_user_creator")),
            ...
            $values["controls"]=array(
				"<span class='badge badge-info'>Usuario</span>".comboUsers($this),
    ...
    public function edit($values){
        try {
            $values["interface"]=(MOD_SUPPORT."/knows/abm");
            $values["page"]=1;
