...
$html.=getHtmlResolved($parameters,"controls","id_type_availability",array("col"=>"col-md-4"));
$html.="</div>";
$html.="<div class='form-row'>";
$html.=getHtmlResolved($parameters,"controls","id_type_exposure",array("col"=>"col-md-4"));
$html.=getInput($parameters,array("col"=>"col-md-4","name"=>"color","type"=>"color","class"=>"form-control text dbase"));
$html.=getHtmlResolved($parameters,"controls","id_server",array("col"=>"col-md-4 pt-2"));
$html.="</div>";
